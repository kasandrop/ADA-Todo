...
| []          | [x]  | 1.1 | Test the Existence of the Repository: Verify that the repository is correctly set up and can be accessed.                                                                                                        |
|             |      |     |                                                                                                                                                                                                                  |
...
| []          | [x]  | 2.5 | Update Label When ID Exists: Verify that when a label is created with an ID that already exists, the existing label is updated and the total count of labels remains the same                                    |
| []          | []   | 2.6 | Update Label Name: Verify that when a label’s name is updated, the change is correctly saved in the database.                                                                                                    |
| []          | []   | 2.7 | Find All Labels: Verify that the repository correctly retrieves all records from Label Table.                                                                                                                    |
| []          | []   | 2.8 | Find Label by Name: Verify that the repository correctly retrieves a label by its name.                                                                                                                          |
|             |      |     |                                                                                                                                                                                                                  |
...
| []          | []   | 3.4 | Update Task Name: Verify that when a task’s name is updated, the change is correctly saved in the database.                                                                                                      |
| []          | []   | 3.5 | Update Task Completion Status: Verify that when a task’s completion status is updated, the change is correctly saved in the database.                                                                            |
| []          | []   | 3.6 | Find All Tasks: Verify that the repository correctly retrieves all records from Task Table.                                                                                                                      |
| []          | []   | 3.7 | Find Task by Name: Verify that the repository correctly retrieves a task by its name.                                                                                                                            |
|             |      |     |                                                                                                                                                                                                                  |
...
| []          | [x]  | 4.1 | Save a Task for an Existing Label: Verify that the repository correctly saves a new task for an existing label.                                                                                                  |
| []          | [x]  | 4.2 |                                                                                                                                                                                                                  |
| []          | [x]  | 4.3 | Delete Tasks When Label is Deleted: Verify that when a label is deleted, all its associated tasks are also deleted.                                                                                              |
| []          | [x]  | 4.4 | Reject Task Creation for Non-Existing Label: Verify that the repository correctly rejects the creation of a task for a non-existing label.                                                                       |
| []          | [x]  | 4.5 | Task References Its Label: Verify that when a task is retrieved by its ID, it correctly references its associated label.                                                                                         |
| []          | [x]  | 4.6 | Label Not Deleted When All Tasks Are Deleted: Verify that when all tasks of a label are deleted, the label itself is not deleted.                                                                                |
...
| []          | [x]  | 5.1 | Raise Exception When Deleting Non-Existing Label: Verify that the repository correctly raises an exception when trying to delete a non-existing label.                                                           |                                                       
| []          | [x]  | 5.2 | Raise Exception When Deleting Non-Existing Task: Verify that the repository correctly raises an exception when trying to delete a non-existing task.                                                             |                                                         
| []          | [x]  | 5.3 | Raise Exception When Creating Label Without Name: Verify that the repository correctly raises an exception when trying to create a label without providing a name  or empty name field.                          |                                         
| []          | [x]  | 5.4 | Raise Exception When Creating Task Without Name: Verify that the repository correctly raises an exception when trying to create a task without providing a name or empty name field.                             |                                          
| []          | [x]  | 5.5 | Raise Exception When Creating Label With Non-Existing ID: Verify that the repository correctly raises an exception when trying to create a label with an ID that doesn't exist (since the ID is auto-generated). |
| []          | [x]  | 5.6 | Raise Exception When Creating Task With Non-Existing ID: Verify that the repository correctly raises an exception when trying to create a task with an ID that doesn't exist (since the ID is auto-generated).   |
| []          | [x]  | 5.7 | Raise Exception When Creating Label With Non-Unique Name: Verify that the repository correctly raises an exception when trying to create a label with a name that is not unique.                                 |
